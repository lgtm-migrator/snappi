...
type OpenapiClient interface {
	...
	// Set specific action/trigger on configuration resources on the traffic generator.
...
func (c *openapiClient) SetAction(ctx context.Context, in *SetActionRequest, opts ...grpc.CallOption) (*SetActionResponse, error) {
	out := new(SetActionResponse)
	err := c.cc.Invoke(ctx, "/otg.Openapi/SetAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOpenapiServer) SetAction(context.Context, *SetActionRequest) (*SetActionResponse, error) {
...
func _Openapi_SetAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OpenapiServer).SetAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/otg.Openapi/SetAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OpenapiServer).SetAction(ctx, req.(*SetActionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Openapi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Openapi_SetAction_Handler,
		},
		{
